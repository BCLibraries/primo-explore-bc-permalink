        ...
        vm.$onInit=function () {
            ...
            $scope.$watch('vm.parentCtrl.shortPermalink',function () {
                if(vm.parentCtrl.item){
                    if(vm.parentCtrl.item.pnx.display.lds28 && vm.parentCtrl.item.pnx.display.lds36 == "DAO") {
                        vm.parentCtrl.shortPermalink = 'https://hdl.handle.net/' + vm.parentCtrl.item.pnx.display.lds28[0];
                    }
                }
            });
	};
